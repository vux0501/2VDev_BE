...
export const unDeletePostForAdminController = async (req: Request, res: Response) => {
  await postsService.unDeletePostForAdmin(req.params.post_id)
  return res.json({
    message: POSTS_MESSAGES.UNDELETE_POST_SUCCESS
  })
}
